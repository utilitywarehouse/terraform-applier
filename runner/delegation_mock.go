...
func (m *MockDelegateInterface) DelegateToken(arg0 context.Context, arg1 kubernetes.Interface, arg2 *v1beta1.Module) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DelegateToken", arg0, arg1, arg2)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDelegateInterfaceMockRecorder) DelegateToken(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DelegateToken", reflect.TypeOf((*MockDelegateInterface)(nil).DelegateToken), arg0, arg1, arg2)
}
