...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicyEvalResult) DeepCopyInto(out *PolicyEvalResult) {
	*out = *in
	if in.HardDenies != nil {
		in, out := &in.HardDenies, &out.HardDenies
		*out = make([]PolicyViolation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SoftDenies != nil {
		in, out := &in.SoftDenies, &out.SoftDenies
		*out = make([]PolicyViolation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyEvalResult.
func (in *PolicyEvalResult) DeepCopy() *PolicyEvalResult {
	if in == nil {
		return nil
	}
	out := new(PolicyEvalResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Run) DeepCopyInto(out *Run) {
	*out = *in
	...
	if in.PolicyResult != nil {
		in, out := &in.PolicyResult, &out.PolicyResult
		*out = new(PolicyEvalResult)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultGCPRequest) DeepCopyInto(out *VaultGCPRequest) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultGCPRequest.
func (in *VaultGCPRequest) DeepCopy() *VaultGCPRequest {
	if in == nil {
		return nil
	}
	out := new(VaultGCPRequest)
	in.DeepCopyInto(out)
	return out
}
